...
function OAuth(opts) {
  ...
  if (!opts.consumer) {
    return logs.captureError('consumer option is required');
  }
  ...
  switch (this.signature_method) {
    ...
    case 'RSA-SHA1':
      logs.captureError('oauth-1.0a does not support this signature method right now. Coming Soon...');
    default:
      logs.captureError('The OAuth 1.0a protocol defines three signature methods: HMAC-SHA1, RSA-SHA1, and PLAINTEXT only');
  }
}
